...
<?php echo form_open_multipart('esemed/lisa'); ?>
...
<div class="form-group">
	...
	<li><a href="#" data-toggle="tooltip" title="Siia sisetatavat teksti näidatakse kuulutuste indekseerimisel">Abiinfo</a></li>

		<span class="help-block">Rohkem kui 50 sõna sisestamisel kuvatakse ainult esimesed 50 sõna.</span>	
...
<div class="form-group">
	<label for="editor1"><?php echo lang("Kirjeldus");?></label>
		<li><a href="#" data-toggle="tooltip" title="Siia sisetatavat teksti näidatakse kuulutuse avamisel">Abiinfo</a></li>
